        ...
        void DrawReferences()
        {
            ...
            if (EvoEditorGUI.DrawFoldout(ref soTarget.referencesFoldout, "References", EvoEditorGUI.GetIcon("UI_References")))
            {
                EvoEditorGUI.BeginContainer();
                {
                    ...
                    if (objectType.enumValueIndex == 0) { EvoEditorGUI.DrawProperty(targetGraphic, "Target Graphic", "Graphic component to style.", false, true, true); }
                    ...
                    else if (objectType.enumValueIndex == 2) { EvoEditorGUI.DrawProperty(targetGraphic, "Target Image", "Image component to style.", false, true, true); }
                }
