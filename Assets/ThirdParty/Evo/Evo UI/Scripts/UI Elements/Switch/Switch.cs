    ...
    public class Switch : Interactive
    {
        ...
        IEnumerator AnimateStates()
        {
            ...
            if (offCG != null)
            {
                ...
                {
                    var cg = offCG[i];
                    if (cg != null) { cachedStateTargets[cg] = isOn ? 0 : 1; }
                }
            }
            ...
            if (onCG != null)
            {
                ...
                {
                    var cg = onCG[i];
                    if (cg != null) { cachedStateTargets[cg] = isOn ? 1 : 0; }
                }
            }
        ...
        void OnValidateDelayCall()
        {
            ...
            // Set on/off states for all off canvas groups (Optimized loop)
            if (offCG != null)
            {
                for (int i = 0; i < offCG.Length; i++)
                {
            ...
            // Set on/off states for all on canvas groups (Optimized loop)
            if (onCG != null)
            {
                for (int i = 0; i < onCG.Length; i++)
                {
