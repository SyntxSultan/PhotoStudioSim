...
public class AppWindow : MonoBehaviour, IPointerDownHandler
{
    ...
    [HideInInspector] public DesktopController Desktop;
    ...
    public void Setup(AppDefinition def, DesktopController desktop)
    {
        Definition = def;
        Desktop = desktop;
    ...
    public void Close()
    {
        ...
        OnClosed();
        PlayCloseAnimation(() => Desktop.CloseWindow(this));
    }

    private void BringToFront() => Desktop.BringToFront(this);
