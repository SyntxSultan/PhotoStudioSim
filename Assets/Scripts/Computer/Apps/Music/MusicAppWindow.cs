...
namespace SyntaxSultan.ComputerSystem.Apps
{
    ...
    {
        [Header("Music App Window")] [Header("Playlist")] [SerializeField]
        private Transform playlistContainer;

        [SerializeField] private PlaylistItem playListItemPrefab;

        [Header("Record")] [SerializeField] private Transform recordImage;
        [SerializeField] private TextMeshProUGUI trackNameText;
        [SerializeField] private float recordRotateSpeed;

        [Header("Volume")] [SerializeField] private Slider trackVolumeSlider;

        [Header("Playbar")] [SerializeField] private Button prevButton;
