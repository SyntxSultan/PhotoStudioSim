...
namespace Computer.Apps.Gallery
{
    public class PrintPopup : MonoBehaviour
    {
        ...
        [SerializeField] private Selector orientationSelector;
        [SerializeField] private Selector fitSelector;
        ...
        private void Awake()
        {
            ...
            PopulateSelectorItems(orientationSelector, typeof(PrintPaperOrientation));
            PopulateSelectorItems(fitSelector, typeof(PrintPaperFit));
        ...
        private PrintSettings GeneratePrintSettings()
        {
            ...
            return new PrintSettings 
            {
                ...
                paperOrientation = ParseSelectorValue<PrintPaperOrientation>(orientationSelector),
                paperFit = ParseSelectorValue<PrintPaperFit>(fitSelector),
